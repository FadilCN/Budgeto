...
function ProfitMargin(props) {
    ...
    const profitmargin = props.income !== 0 ? (props.profit / props.income) * 100 : 0;
    const preprofitmargin = props.preincome !== 0 ? (props.preprofit / props.preincome) * 100 : 0;
    const diff = Math.abs(profitmargin - preprofitmargin);
    const key = profitmargin < preprofitmargin ? 1 : 0;
    const percentage = Math.round(profitmargin);
