...
import { CircleDollarSign ,TrendingUp ,ChartLine, TrendingDown} from "lucide-react";
...
function CardArea(props) {
    ...
    return (
        <div className=" rounded-md   h-[175px] min-w-[350px] border border-gray-200  bg-white p-4 hover:scale-101 transition-transform duration-100 " >
            <div className="grid grid-cols-[20%_80%] gap-4 h-full">

                <div className="flex flex-col justify-between">
                    <div className="flex flex-row  pb-1  gap-2">
                        <div>    <ChartLine className="w-6 h-6 text-blue-500" /> </div>
                    ...
                    <div className="mb-1">
                        ...
                        <div className="mb-1 text-xs text-gray-900 flex flex-cols">
                            ...
                            } rounded-2xl flex flex-rows gap-1 h-5`}>
                ...
                <div className="h-38 w-full flex align-middle  rounded-md p-3 ">
                    <ResponsiveContainer height={150}>
                        ...
                        >
                            {/* Grid lines */}
                            <CartesianGrid stroke="#d1d5db" strokeDasharray="3 3" /> {/* gray grid */}

                            {/* X Axis */}
                            <XAxis
                                dataKey="value"
                                tick={{ fontSize: 10, fill: "#6b7280" }} // xs text, gray color
                                axisLine={{ stroke: "#6b7280" }} // axis line gray
                            />
                            ...
                            {/* Tooltip */}
                            <Tooltip
                                contentStyle={{ fontSize: "10px", color: "#6b7280", backgroundColor: "#f9fafb" }}
                            />

                            {/* Area */}
                            <Area type="monotone" dataKey="value" stroke="#1E40AF" fill="#BFDBFE"   strokeWidth={2}   />
                        </AreaChart>
                    </ResponsiveContainer>
                </div>
