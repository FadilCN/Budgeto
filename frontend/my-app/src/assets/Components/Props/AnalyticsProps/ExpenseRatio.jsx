...
function ExpenseRatio(props) {
    const expenseratio = props.income !== 0 ? (props.expense / props.income) * 100 : 0;
    const preexpenseratio = props.preincome !== 0 ? (props.expense / props.preincome) * 100 : 0;

    const diff = Math.abs(expenseratio - preexpenseratio);
    const key = expenseratio < preexpenseratio ? 1 : 0;
    const percentage = Math.round(expenseratio);
